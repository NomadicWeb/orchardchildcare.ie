        <div id="footerwrap">
            <div class="container">
                <h4>Created by <a href="#">NomadicWeb</a> - Copyright 2014</h4>
            </div>
        </div>
    ...
    <!--<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/jquery-func.js"></script>-->
  </body>
</html> 
