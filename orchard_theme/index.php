        ...
        <br>
            ...
            <div class="row">   
                <div class="col-md-4 ">
                    <div class="grid mask">
                        <figure>
                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/folio04.jpg" alt="">
                            <figcaption>
                                <h5>PROFILE</h5>
                                <a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
                            </figcaption><!-- /figcaption -->
                ...
                <div class="col-md-4">
                    <div class="grid mask">
                        <figure>
                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/folio05.jpg" alt="">
                            <figcaption>
                ...
                <div class="col-md-4">
                    <div class="grid mask">
                        <figure>
                            <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio/folio06.jpg" alt="">
                            <figcaption>
                                <h5>PHONE MOCKUP</h5>
                                <a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
                            </figcaption><!-- /figcaption -->
        ...
        <br>
            ...
            <div class="row">
                <div class="col-lg-6 blog-bg">
                    ...
                    <br>
                        <p><img class="img img-circle" src="<?php echo get_template_directory_uri(); ?>/assets/img/team/team04.jpg" width="60px" height="60px"></p>
                        <h4>Jaye Smith</h4>
                ...
                <div class="col-lg-6 blog-bg">
                    <div class="col-lg-4 centered">
                    <br>
                        <p><img class="img img-circle" src="<?php echo get_template_directory_uri(); ?>/assets/img/team/team03.jpg" width="60px" height="60px"></p>
                        <h4>Michele Lampa</h4>
